...
// SYSTEMA ADMIN - LIBRARY
const C_SYSA_LIB_BOOK_MGT =
    import ('./components/pages/sysa/sysa_book_mgt.vue')
const C_SYSA_LIB_BORROW_LOG =
    import ('./components/pages/sysa/sysa_borrow_log.vue')
const C_SYSA_LIB_DONORS =
    import ('./components/pages/sysa/sysa_ent_donor.vue')
const C_SYSA_LIB_BORROWERS =
    import ('./components/pages/sysa/sysa_ent_borrower.vue')
...
const routes = [
    ...
    },
    {
        path: '/front/sysa',
        children: [
            { path: 'bkmgt', component: () => C_SYSA_LIB_BOOK_MGT },
            { path: 'brwlg', component: () => C_SYSA_LIB_BORROW_LOG },
            { path: 'donors', component: () => C_SYSA_LIB_DONORS },
            { path: 'borrowers', component: () => C_SYSA_LIB_BORROWERS },
